namespace InterPlayersTest.Infra.Validation
{
    public static class ErrorMessages
    {
        ...
        public static string passwordUpperCase = "Senha deve ter pelo menos 1 (um) caractere maiúsculo";
        public static string passwordCharactersSpecial = "Senha tem que ter pelo menos 1 (um) caractere especial Ex.: (!@#$%^&*()-+)";
